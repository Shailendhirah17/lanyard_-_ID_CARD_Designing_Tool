...
export const lengths = [
  { label: '28', price: 0, description: 'Smallest size.' },
  { label: '30', price: 0, description: 'Compact size.' },
  { label: '32', price: 0, description: 'Medium short size.' },
  { label: '34', price: 0, description: 'Medium long size.' },
  { label: '38', price: 0, description: 'Final and standard company size.' },
];

export const clipTypes = [
  { label: 'Metal Hook', price: 0, description: 'Classic sturdy metal clip.', image: 'https://images.unsplash.com/photo-1544473244-f6895e69da8a?w=150&h=150&fit=crop' },
  { label: 'Plastic Hook', price: 3, description: 'Lightweight clip with a softer finish.', image: 'https://images.unsplash.com/photo-1590212151175-e58edd96185b?w=150&h=150&fit=crop' },
  { label: 'Crocodile Clip', price: 4, description: 'Strong grip clip for badge holders.', image: 'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=150&h=150&fit=crop' },
  { label: 'Ski Reel', price: 6, description: 'Retractable reel for easy badge scanning.', image: 'https://images.unsplash.com/photo-1581414441551-f76785e054bd?w=150&h=150&fit=crop' },
];
...
export const gradientPresets = [
  ...
  { name: 'Mint Wave', value: 'linear-gradient(90deg, #43cea2, #185a9d)' },
  { name: 'Skyline', value: 'linear-gradient(90deg, #74ebd5, #9face6)' },
  { name: 'Berry Pop', value: 'linear-gradient(90deg, #f953c6, #b91d73)' },
  { name: 'Arctic Blue', value: 'linear-gradient(90deg, #00c6ff, #0072ff)' },
  { name: 'Golden Hour', value: 'linear-gradient(90deg, #f6d365, #fda085)' },
  { name: 'Forest Mist', value: 'linear-gradient(90deg, #5a3f37, #2c7744)' },
  { name: 'Cool Slate', value: 'linear-gradient(90deg, #4b79a1, #283e51)' },
  { name: 'Rose Gold', value: 'linear-gradient(90deg, #e6b980, #eacda3)' },
];
