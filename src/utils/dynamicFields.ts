...
export const formatFieldValue = (field: DynamicField, value: unknown): string => {
...
export const validateFieldValue = (field: DynamicField, value: unknown): { valid: boolean; error?: string } => {
...
export const replaceFieldsInText = (text: string, data: Record<string, unknown>): string => {
